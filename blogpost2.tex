...
\sophie{In the final instalment of the \href{http://www.appliedcategorytheory.org/school/}{Applied Category Theory seminar}, we discussed the 2014 paper  \href{http://iopscience.iop.org/article/10.1088/1367-2630/16/11/113043/meta}{\emph{``Theory-independent limits on correlations from generalized Bayesian networks''}} by Henson, Lal and Pusey. 

In this post, we'll give a short introduction to Bayesian networks, explain why quantum mechanics means that one may want to generalise them, and present the main results of the paper. That's a lot to cover, so there won't be a huge amount of category theory, but we hope to give the reader some intuition about the issues involved and how monoidal categories have a role to play in causal theory.}
...
{ \begin{figure}[H]
\centering \includegraphics[width= 8cm]{blogpost_figures/fig1.png} \end{figure} }
...
\vskip 2ex
Bayesian networks are useful \marginpar{\sophie{Pablo - do you have better links for these things than I could find?}}
\begin{itemize}
\item as an inference tool, for example in belief propagation [LINK],
...
{ \begin{figure}[H]
\centering \includegraphics[width= 8cm]{blogpost_figures/fig1b.png} \end{figure} }
...
{ \begin{figure}[H]
\centering \includegraphics[width= 8cm]{blogpost_figures/fig1c.png} \end{figure} }
...
{ \begin{figure}[H]
\centering \includegraphics[width= 12cm]{blogpost_figures/fig2.png} \end{figure} }

A priori, \emph{Allergic reaction} is conditionally independent of \emph{Fever}. Indeed, we have the partition

\begin{figure}[H]
\centering \includegraphics[width= 12cm]{blogpost_figures/fig3.png} \end{figure} 
...
\begin{figure}[H]
\centering \includegraphics[width= 12cm]{blogpost_figures/fig4.png} \end{figure} 
...
\begin{figure}[H]
\centering \includegraphics[width= 9cm]{blogpost_figures/fig5.png} \end{figure} 
...
\begin{figure}[H]
\centering \includegraphics[width= 7cm]{blogpost_figures/fig6.png} \end{figure} 
...
All that matters is that the hidden variable helps to explain the observed correlations.
 \begin{figure}[H]
\centering \includegraphics[width= 8cm]{blogpost_figures/fig7.png} \end{figure} 
...
\marginpar{ \sophie{Pablo, shall we link to the \href{https://link.springer.com/chapter/10.1007/978-94-017-0990-3_45}{paper} or, e.g. this\href{https://www.scienceandnonduality.com/why-isnt-quantum-mechanics-even-weirder/}{blogpost}? I ask the same question below!}}
...
The existence of a discard map allows a definition of \emph{causal morphisms} in a causal theory. For example, as we saw in\href{https://golem.ph.utexas.edu/category/2018/01/a_categorical_semantics_for_ca.html#more}{January}, a test $\{ \mathcal C_i \}_i \in \mathsf C (A, B)$ is \emph{causal} if 
...
Finally, \pablo{Boxworld [LINK] is the theory that allows to describe any correlation between two variables as the cause of some resource of the theory in the past}.
...
\begin{figure}[H]
\centering \includegraphics[width= 7cm]{blogpost_figures/fig8.png} \end{figure} 
...
\begin{figure}[H]
\centering \includegraphics[width= 7cm]{blogpost_figures/fig9.png} \end{figure} 
...
\begin{figure}[H]
\centering \includegraphics[width= 8cm]{blogpost_figures/fig10.png} \end{figure} 
...
\item The set $\mathcal G$ of all generalised Markov distributions on $G$. \sophie{(This is the set of generalised Markov distributions in Boxworld [LINK BACK UP].)}
