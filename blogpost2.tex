...
\item and because, given a Bayesian network $(G,P)$, we can describe \emph{d-separation} [LINK to \S~2.2] properties on $G$ which enable us to discover conditional independences in $P$. 
